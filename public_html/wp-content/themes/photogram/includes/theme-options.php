...
$options[] = array( "name" => __( "Home Page Content", "colabsthemes" ),
					...
					"std" => "Posts",
					"type" => "select2",
					"options" => array( "Posts" => __("Posts", "colabsthemes"), "Picasa" => __("Picasa", "colabsthemes"), "Flickr" => __("Flickr", "colabsthemes"), "Photographs" => __("Photographs", "colabsthemes"), "Pinterest" => __("Pinterest", "colabsthemes"), "Instragram" => __("Instragram", "colabsthemes") ) );
